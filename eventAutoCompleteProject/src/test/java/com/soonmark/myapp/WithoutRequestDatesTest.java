...
public class WithoutRequestDatesTest {
	...
	public static Collection<Object[]> testCases() {
		...
		params.add(new Object[] { "20-10-1",
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2020-10-01", ""), null, "2020-10-01 ~")) });
		
		params.add(new Object[] { "1999/01/01",
				Arrays.asList(new EventDTO(new StringDateTimeDTO("1999-01-01", ""), null, "1999-01-01 ~")) });
		                                                                                  
		params.add(new Object[] { "11/3/19",                                              
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2011-03-19", ""), null, "2011-03-19 ~")) });
		                                                                                  
		params.add(new Object[] { "11/3/1",                                               
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2011-03-01", ""), null, "2011-03-01 ~")) });
		                                                                                  
		params.add(new Object[] { "2025.2.2",                                             
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2025-02-02", ""), null, "2025-02-02 ~")) });
		                                                                                  
		params.add(new Object[] { "00.12.10",                                             
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2000-12-10", ""), null, "2000-12-10 ~")) });
                                                                                          
		params.add(new Object[] { "10.10.09",                                             
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2010-10-09", ""), null, "2010-10-09 ~")) });

		// 년 월
		params.add(new Object[] { "벚꽃달인 18년 4월 계획짜기",
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2018-04-28", ""), null, "2018-04-28 ~"),
						new EventDTO(new StringDateTimeDTO("2018-04-29", ""), null, "2018-04-29 ~")) });

		params.add(new Object[] { "내 생일 94년 6월 중",
				Arrays.asList(new EventDTO(new StringDateTimeDTO("1994-06-01", ""), null, "1994-06-01 ~"),
						new EventDTO(new StringDateTimeDTO("1994-06-02", ""), null, "1994-06-02 ~")) });

		// 년 일
		params.add(new Object[] { "2000년 21일에 여행갔었음.",
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2000-01-21", ""), null, "2000-01-21 ~"),
						new EventDTO(new StringDateTimeDTO("2000-02-21", ""), null, "2000-02-21 ~")) });
                                                                                          
		params.add(new Object[] { "2018년 4일에 여행갔었음.",                                     
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2018-05-04", ""), null, "2018-05-04 ~"),
						new EventDTO(new StringDateTimeDTO("2018-06-04", ""), null, "2018-06-04 ~")) });
                                                                                          
		// 월 일                                                                            
		params.add(new Object[] { "4-9",                                                  
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2019-04-09", ""), null, "2019-04-09 ~")) });
		                                                                                  
		params.add(new Object[] { "1/1 신년행사",                                             
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2019-01-01", ""), null, "2019-01-01 ~")) });
                                                                                          
		// 년                                                                              
		params.add(new Object[] { "15년",                                                  
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2015-01-01", ""), null, "2015-01-01 ~"),
						new EventDTO(new StringDateTimeDTO("2015-01-02", ""), null, "2015-01-02 ~")) });
                                                                                          
		params.add(new Object[] { "07년에 중학교 졸업",                                          
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2007-01-02", ""), null, "2007-01-01 ~"),
						new EventDTO(new StringDateTimeDTO("2007-01-02", ""), null, "2007-01-02 ~")) });
                                                                                          
		// 월                                                                              
		params.add(new Object[] { "2월에 졸업식",                                              
				Arrays.asList(new EventDTO(new StringDateTimeDTO("2018-04-09", ""), null, "")) });
